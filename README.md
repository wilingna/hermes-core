...
> 下面是一个**示意性例子**(不是真实会议),为了让你一眼看出"加 Hermes"和"不加 Hermes"在 handoff 那一刻的差别。真实的工程化案例见后面 [Case Study](#-case-study)。
...
- 🛠 [ai-ppt-toolkit](https://github.com/wilingna/ai-ppt-toolkit) — 三件套做 PPT 完整工作流
